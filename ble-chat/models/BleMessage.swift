...
struct BleMessage: Codable, Equatable, Hashable, Identifiable {
  let id: String
  let sender: String
  let content: String
  let timestamp: Date
...
extension BleMessage {
    func toBinaryPayload() -> Data? {
        ...
        if let peerData = senderPeerID?.data(using: .utf8) {
...
extension Array where Element == BleMessage {

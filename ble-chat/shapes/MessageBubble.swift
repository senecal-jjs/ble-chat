...
// to learn more checkout https://medium.com/@jpmtech/creating-custom-shapes-in-swiftui-1ac3743cd500
...
@ViewBuilder
func ImageAttachmentView(_ thumbnail: Image, isFromYou: Bool, shouldSendInTheFuture: Bool)
  -> some View
{
  var forgroundColor: Color {
    if shouldSendInTheFuture {
...
@ViewBuilder
func VideoAttachmentView(_ thumbnail: Image, isFromYou: Bool, shouldSendInTheFuture: Bool)
  -> some View
{
  var forgroundColor: Color {
    if shouldSendInTheFuture {
...
@ViewBuilder
func OtherAttachmentView(
  _ thumbnail: Image, fileName: String, docType: String, fileSize: String, isFromYou: Bool,
  shouldSendInTheFuture: Bool
) -> some View {
  var messageFillColor: Color {
    if shouldSendInTheFuture {
      return Color.clear
